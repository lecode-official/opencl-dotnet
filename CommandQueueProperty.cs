...
namespace OpenCl.DotNetCore
{
    ...
    public enum CommandQueueProperty : uint
    {
        ...
        /// in the command-queue are executed out-of-order. Otherwise, commands are executed in-order.
        /// </summary>
        QueueOutOfOrderExecutionModeEnable = 1 << 0,

        /// <summary>
        /// Enables or disables profiling of commands in the command-queue. If set, the profiling of commands is enabled. Otherwise
