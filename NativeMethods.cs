...
namespace OpenCl.DotNetCore
{
    ...
    public static class NativeMethods
    {
        ...
        /// <see cref="context"/> is created using <see cref="CreateContext"/> or have the same device type as the device type
        ...
        /// properties specified below can be set in properties; otherwise the value specified in properties is considered to be
        /// not valid.
        /// 
        ...
        /// 
        /// <c>Result.QueueProfilingEnable</c>: Enable or disable profiling of commands in the command-queue. If set, the profiling
        ...
        /// </param>
        /// <returns>
        /// Returns a valid non-zero command-queue and <see cref="errcode_ret"/> is set to <c>Result.Success</c> if the command-queue
        /// is created successfully. Otherwise, it returns a <c>null</c> value with an error values returned in
